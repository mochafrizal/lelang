	...
	<section class="section">
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="card">
					<div class="card-body">
						<form action="<?php echo base_url() ?>pelelang/riwayatlelang/edit_konfirmasi_post/<?php echo $auction_item->id ?>" method="POST" enctype="multipart/form-data">
							<div class="form-group">
								<label>Nama Penerima<span class="text-danger">*</span></label>
								<input type="text" class="form-control" name="recipient_name" value="<?php echo $payment->recipient_name ?>" required>
							</div>
							<div class="form-group">
								<label>Alamat Penerima<span class="text-danger">*</span></label>
								<textarea class="form-control" name="recipient_address" rows="3" style="height: 100px"><?php echo $payment->recipient_name ?></textarea>
							</div>
							<div class="form-group">
								<label>Bukti Bayar</label>
								<input type="file" name="proof_payment" accept="image/jpeg,image/jpg,image/png" class="form-control-file" id="exampleFormControlFile1" >
							</div>
